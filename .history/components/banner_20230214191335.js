...
export default function banner(props) {
  return (
    <div className='flex flex-col items-center md:ml-12 mt-[80px]'>
      <h1>
      ...
      <button className='mdw-[20%] bg-[#4B0082] text-[#f5f5f5] text-lg px-4 py-2 rounded-md' onClick={props.handleOnClick}>{props.buttonText}</button>
    </div>
  )
}
