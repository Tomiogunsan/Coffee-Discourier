...
export default function banner(props) {
  return (
    <div className='flex flex-col ml-[80px] mt-[80px]'>
      <h1>
      ...
      <button className='w-[20%] bg-[#4B0082] text-[#f5f5f5] text-px-4 py-2 rounded-md' onClick={props.handleOnClick}>{props.buttonText}</button>
    </div>
  )
}
