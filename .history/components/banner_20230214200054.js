  ...
  return (
    <div className='max-w-6xl mx-auto md:ml-12 mt-[80px] ml-4'>
      <h1 >
        ...
        <span className='text-[#4B0082] block md:inline-block text-[45px] md:text-6xl font-bold md:ml-2 '>Discourier</span>
      </h1>
      <p className='text-[#f5f5f5] text-xl md:text-2xl py md:py-4'>Discover your local coffee shops!</p>
